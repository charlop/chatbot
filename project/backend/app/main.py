...
from app.api.v1 import contracts, extractions, audit, chat, admin, state_rules
...
app.include_router(state_rules.router, prefix=settings.api_v1_prefix, tags=["State Rules"])
